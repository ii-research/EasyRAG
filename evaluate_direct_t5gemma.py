"""
Direct Baseline Evaluation Script with T5Gemma2 (No RAG)
========================================================

Evaluates a T5Gemma2 model trained without any retrieval.
...
Usage:
    ...
    python evaluate_direct_t5gemma.py --checkpoint checkpoints/direct_t5gemma/step_10000 \
...
class DirectT5GemmaEvaluator:
    """
    Direct baseline evaluator with T5Gemma2 (no retrieval, question-only input).
    ...
    def evaluate(self) -> Dict[str, Dict[str, float]]:
        ...
        print(f"\n{'='*60}")
        print("Direct T5Gemma2 Baseline Evaluation (No RAG, Question-Only)")
        print(f"{'='*60}")
    ...
    def _save_results(self, results: Dict[str, Dict[str, float]]) -> None:
        ...
        if self.args.output:
            ...
            results_path = os.path.join(self.args.checkpoint, "eval_results_direct_t5gemma.json")
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Direct T5Gemma2 Baseline Evaluation (No RAG)",
...
def main():
    ...
    evaluator = DirectT5GemmaEvaluator(args)

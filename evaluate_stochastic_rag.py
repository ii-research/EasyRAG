"""
Stochastic RAG Evaluation Script
=================================
...
Usage:
    python evaluate_stochastic_rag.py --checkpoint checkpoints/stochastic_rag/final --task nq
...
class StochasticRAGEvaluator:
    """Stochastic RAG model evaluator with KILT Score computation."""
    ...
    def generate(
        ...
        with torch.no_grad():
            ...
            if self.use_reranker:
                ...
                # Debug: print raw selection before sorting
...
def print_metrics(metrics: Dict[str, Any]) -> None:
    ...
    print("\n" + "=" * 80)
    print("Stochastic RAG Evaluation Results")
    print("=" * 80)
...
def main():
    parser = argparse.ArgumentParser(description="Evaluate Stochastic RAG model")
    parser.add_argument(
        "--checkpoint",
        type=str,
        default="checkpoints/stochastic_rag/final",
